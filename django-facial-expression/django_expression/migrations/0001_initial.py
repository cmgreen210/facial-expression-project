    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveIntegerField(help_text=b'0 for video, 1 for image,                                                 any other undefined', validators=[
                    expression.models.validate_request_type])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request', models.ForeignKey(to='django-facial-django_expression.django_expression.ClassificationRequest')),
            ],
            options={
            },
            bases=(models.Model,),
